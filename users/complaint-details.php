...
<html lang="en">
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <?php
        $query=mysqli_query($bd, "SELECT tblcomplaints.*, category.categoryName as catname, tblcomplaints.subcategory 
                                FROM tblcomplaints 
        ...
        <div class="row mt">
          ...
          <div class="col-sm-10">
            ...
            <b>Remark Date: <?php echo htmlentities($rw['rdate']); ?></b>
          </div>
        </div>
  ...
  <!-- JS placed at the end of the document so pages load faster -->
